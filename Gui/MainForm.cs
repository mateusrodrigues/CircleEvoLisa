...
namespace GenArt
{
    public partial class MainForm : Form
    {
        ...
        private DnaCircleDrawing currentDrawing;

        private double errorLevel = double.MaxValue;
        private int generation;
        private DnaCircleDrawing guiDrawing;
        ...
        private void OpenDNA()
        {
            ...
            //DnaCircleDrawing drawing = Serializer.DeserializeDnaCircleDrawing(FileUtil.GetOpenFileName(FileUtil.DnaExtension));
            //if (drawing != null)
            //{
            //    if (currentDrawing == null)
            //        currentDrawing = GetNewInitializedDrawing();
